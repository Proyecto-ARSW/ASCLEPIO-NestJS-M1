...
@ObjectType({
  description: 'Registro de inventario de un medicamento en una sede',
})
export class InventarioMedicamento {
  ...
  @Field(() => Int, {
    description: 'Stock actual del medicamento en esta sede',
  })
  stockActual: number;
  ...
  @Field({
    description: 'Fecha de última actualización (gestionada por trigger)',
  })
  actualizadoEn: Date;
}
